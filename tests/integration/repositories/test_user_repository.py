...
class TestAdd:
    ...
    async def test_add_user_duplicate_email(self, user_repository: UserRepository, user: User):
        duplicate_user = User(
            email=user.email,
    ...
    async def test_add_user_duplicate_username(self, user_repository: UserRepository, user: User):
        duplicate_user = User(
...
class TestUpdate:
    async def test_update_user(self, user_repository: UserRepository, user: User):
