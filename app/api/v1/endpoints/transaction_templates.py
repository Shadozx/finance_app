...
from app.schemas import TransactionTemplateResponse, TransactionTemplateCreate, TransactionTemplateUpdate
...
async def update_transaction_template(
    ...
    return await transaction_template_service.update_template(transaction_template_id, data, current_user.id)
